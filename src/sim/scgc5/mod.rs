...
#[doc = "Possible values of the field `LPTIMER`"]
...
impl LPTIMERR {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> LPTIMERR {
        match value {
            false => LPTIMERR::_0,
            true => LPTIMERR::_1,
        }
...
#[doc = "Values that can be written to the field `LPTIMER`"]
pub enum LPTIMERW {
    #[doc = "Access disabled"]
    _0,
    #[doc = "Access enabled"]
...
#[doc = r" Proxy"]
pub struct _LPTIMERW<'a> {
    w: &'a mut W,
}
impl<'a> _LPTIMERW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: LPTIMERW) -> &'a mut W {
        {
    ...
    pub fn _0(self) -> &'a mut W {
        self.variant(LPTIMERW::_0)
    }
    #[doc = "Access enabled"]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(LPTIMERW::_1)
    }
...
impl W {
    ...
    #[doc = "Bit 0 - Low Power Timer Access Control"]
    #[inline]
    pub fn lptimer(&mut self) -> _LPTIMERW {
        _LPTIMERW { w: self }
    }
    #[doc = "Bit 5 - TSI Clock Gate Control"]
    #[inline]
