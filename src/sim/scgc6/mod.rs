...
#[doc = "Possible values of the field `FTFL`"]
...
#[doc = "Values that can be written to the field `FTFL`"]
pub enum FTFLW {
    #[doc = "Clock disabled"]
    _0,
    #[doc = "Clock enabled"]
...
impl<'a> _FTFLW<'a> {
    ...
    #[inline]
    pub fn variant(self, variant: FTFLW) -> &'a mut W {
        {
    ...
    pub fn _0(self) -> &'a mut W {
        self.variant(FTFLW::_0)
    }
    #[doc = "Clock enabled"]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(FTFLW::_1)
    }
